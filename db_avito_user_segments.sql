...
--
-- Host: localhost    Database: db_avito
-- ------------------------------------------------------
...
CREATE TABLE `user_segments` (
  ...
  CONSTRAINT `user_segments_ibfk_1` FOREIGN KEY (`segment_id`) REFERENCES `segments` (`id`)
...
INSERT INTO `user_segments` VALUES (1000,1),(1000,2),(1002,1),(1002,4),(1000,1);
...
-- Dump completed on 2023-08-31 19:37:21
